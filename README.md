...
The Hello Rails React App is an educational project aimed at exploring the seamless integration of React within a Rails application.
...
```sh
  cd Blog app
  git clone https://github.com/peter-akhigbe/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/peter-akhigbe/hello-rails-react/issues).
